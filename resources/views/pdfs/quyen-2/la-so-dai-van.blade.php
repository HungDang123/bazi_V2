...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nv-tc-row td  { height: 16mm; background-color: #F3F3F3; }
        .nv-dc-row td  { height: 12mm; background-color: #F3F3F3; }
        .nv-tang-row td{ height: 7mm;  background-color: #F3F3F3; padding: 0.5mm; }
