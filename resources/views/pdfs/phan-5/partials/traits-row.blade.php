@php
    ...
    $tichPillSrc = PdfImageEmbed::src($tichPill);
    $tieuPillSrc = PdfImageEmbed::src($tieuPill);
    ...
    <tr style="height: {{ $boxHeightMm }}mm;">
        <td class="traits-col traits-col-left" style="height: {{ $boxHeightMm }}mm;">
            <div class="trait-box tich-cuc" style="height: {{ $boxHeightMm }}mm;">
                <div class="trait-pill-wrap">
                    @if ($tichPillSrc !== '')
                    <img class="trait-pill-img" style="width: {{ $pillSize['widthMm'] }}mm; height: {{ $pillSize['heightMm'] }}mm;" src="{!! $tichPillSrc !!}" alt="Tích cực">
                    @else
        ...
        <td class="traits-col traits-col-right" style="height: {{ $boxHeightMm }}mm;">
            <div class="trait-box tieu-cuc" style="height: {{ $boxHeightMm }}mm;">
                <div class="trait-pill-wrap">
                    @if ($tieuPillSrc !== '')
                    <img class="trait-pill-img" style="width: {{ $pillSize['widthMm'] }}mm; height: {{ $pillSize['heightMm'] }}mm;" src="{!! $tieuPillSrc !!}" alt="Tiêu cực">
                    @else
