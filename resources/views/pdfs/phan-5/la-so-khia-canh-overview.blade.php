...
<div class="page">
    ...
    <div class="content-zone" style="top: {{ $page['contentZoneTopMm'] ?? 18 }}mm; height: {{ $page['contentZoneHeightMm'] ?? 240 }}mm; left: {{ $page['contentLeftMm'] ?? 24 }}mm; width: {{ $page['contentWidthMm'] ?? 162 }}mm;">
